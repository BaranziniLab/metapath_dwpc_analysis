conda run -n pagerank python metapath_dwpc_analysis.py ../../dwpc_data/food_nodes.csv Food DOID:2355 Disease identifier ../../spoke_35M_data/spoke_metagraph.gpickle ../../spoke_35M_data/spoke_35M_compound_pruned_version.gpickle ../../dwpc_data/ dwpc_food_anemia_disease.pickle 120 >> logs/dwpc_food_anemia_disease_after_funky_edge_correction_1.log 2>&1 &
